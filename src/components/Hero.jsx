...
export default function Hero() {
  ...
  return (
    <header id="about" className="relative min-h-screen flex flex-col items-center justify-center gap-12 px-6 py-20 md:flex-row md:px-20 overflow-hidden bg-linear-to-b from-neutral-900 to-black">
